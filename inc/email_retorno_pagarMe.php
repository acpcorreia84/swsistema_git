    ...
    <td align="center"><table width="600" border="0" cellpadding="10" cellspacing="0">
      ...
      <tr >
        <td align="left" bgcolor="#FFFFFF" style="background-color: #ffffff; border-bottom:2px solid #c7c7c7;"><p>&nbsp;</p>
          <p><a href="https://www.facebook.com/gruposerama/?ref=aymt_homepage_panel" style="text-decoration: none; color: #555555; font-weight: bold; font-size:22px" ><span style="color: rgb(51, 102, 153); ">Boleto de Pagamento</span></a></p></td>
      </tr>
      <tr>
        <td align="left" bgcolor="#FFFFFF"><p style="color:#696969;"><strong>Cliente</strong>: <?=$nome;?><br />
          ...
          : 
            ...
            <?=date('d/m/Y H:i:s')?>
            <br />
            <strong>Boleto</strong>: <?=$_POST['id']?></p>
          <p style="color:#696969;">&nbsp;</p></td>
      </tr>
      <tr>
