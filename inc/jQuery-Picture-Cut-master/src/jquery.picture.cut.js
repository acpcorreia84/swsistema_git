                ...
                var TuyoshiCrop = function(element, response) {
                    ...
                    var MontarSelecaoRecorte = function(SelecaoRecorte, state) {
                        ...
                        if (state == "create") {                            
                            ...
                            if (Options.CropModes.free) ElemSelectProporcao.append($('<option value="livre">Livre</option>'));
                    ...
                    else if (Options.CropWindowStyle == "bootstrap") PcDialog(Options.PluginFolderOnServer + CropWindowStyle[Options.CropWindowStyle], "JtuyoshiCrop", "Cortar Imagem", 200, 300, true, true, false, null, JpaneDialogCallBack)
                };
