 ...
 */
/*INSERE FUNCOES DE VALIDACAO PARA TODAS AS TELAS*/
...
$.validator.addMethod("validaCnpj", function(value, element) {
    var cnpjSemFormatacao = value.replace(/[\.-]/g, "");

    return this.optional(element) || validarCnpj(cnpjSemFormatacao);
}, "Este CNPJ n&atilde;o &eacute; v&aacute;lido. Por favor confira a informa&ccedil;&atilde;o e tente novamente");
...
//    var cpfSemFormatacao = value.replace(/[\.-]/g, "");
...
$.validator.addMethod("validaCpf", function(value, element) {
    ...
    return this.optional(element) || validarCpf(cpfSemFormatacao);
}, "Este Cpf n&atilde;o &eacute; v&aacute;lido. Por favor confira a informa&ccedil;&atilde;o e tente novamente");
...
$.validator.addMethod("emailGrupoSerama", function(value, element) {
    return this.optional(element) || /\[A-Za-z0-9\\._-][@]\[gruposerama.com.br]/g.test(value);
}, "N&atilde;o pode ser cadastrado e-mail com dom&iacute;nios @gruposerama.com.br");
