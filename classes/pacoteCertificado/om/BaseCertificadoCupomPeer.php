...
/**
 * Base static class for performing query and update operations on the 'certificado_cupom' table.
 *
 * 
 *
 * @package    pacoteCertificado.om
 */
abstract class BaseCertificadoCupomPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'swsistema';

	/** the table name for this class */
	const TABLE_NAME = 'certificado_cupom';

	/** the related Propel class for this table */
	const OM_CLASS = 'CertificadoCupom';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'pacoteCertificado.CertificadoCupom';
	...
	const DATA_VENCIMENTO = 'certificado_cupom.DATA_VENCIMENTO';

	/** the column name for the DATA_EMISSAO field */
	const DATA_EMISSAO = 'certificado_cupom.DATA_EMISSAO';
	...
	/** the column name for the VALOR_FINAL field */
	const VALOR_FINAL = 'certificado_cupom.VALOR_FINAL';

	/** the column name for the DESCRICAO field */
	const DESCRICAO = 'certificado_cupom.DESCRICAO';

	/** the column name for the OBSERVACAO field */
	const OBSERVACAO = 'certificado_cupom.OBSERVACAO';

	/**
	 * An identiy map to hold any loaded instances of CertificadoCupom objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array CertificadoCupom[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. CertificadoCupomPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(CertificadoCupomPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CertificadoCupomPeer::OBSERVACAO);
	}
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = CertificadoCupomPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return CertificadoCupomPeer::populateObjects(CertificadoCupomPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      CertificadoCupom $value A CertificadoCupom object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(CertificadoCupom $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A CertificadoCupom object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof CertificadoCupom) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or CertificadoCupom object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     CertificadoCupom Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to certificado_cupom
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = CertificadoCupomPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = CertificadoCupomPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				CertificadoCupomPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	...
	public static function doSelectJoinCertificado(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (CertificadoCupom) to $obj2 (Certificado)
	...
	/**
	 * Selects a collection of CertificadoCupom objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseCertificadoCupomPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseCertificadoCupomPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new CertificadoCupomTableMap());
	  }
	}
	...
	{
		return $withPrefix ? CertificadoCupomPeer::CLASS_DEFAULT : CertificadoCupomPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a CertificadoCupom or Criteria object.
	 *
	 * @param      mixed $values Criteria or CertificadoCupom object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from CertificadoCupom object
		}

		if ($criteria->containsKey(CertificadoCupomPeer::ID) && $criteria->keyContainsValue(CertificadoCupomPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.CertificadoCupomPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a CertificadoCupom or Criteria object.
	 *
	 * @param      mixed $values Criteria or CertificadoCupom object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(CertificadoCupomPeer::ID);
			$selectCriteria->add(CertificadoCupomPeer::ID, $criteria->remove(CertificadoCupomPeer::ID), $comparison);

		} else { // $values is CertificadoCupom object
	...
	/**
	 * Method to DELETE all rows from the certificado_cupom table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(CertificadoCupomPeer::TABLE_NAME, $con);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			CertificadoCupomPeer::clearInstancePool();
			CertificadoCupomPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a CertificadoCupom or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or CertificadoCupom object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof CertificadoCupom) { // it's a model object
			// invalidate the cache for this single object
			CertificadoCupomPeer::removeInstanceFromPool($values);
			// create criteria based on pk values
			$criteria = $values->buildPkeyCriteria();
		} else { // it's a primary key, or an array of pks
			$criteria = new Criteria(self::DATABASE_NAME);
			$criteria->add(CertificadoCupomPeer::ID, (array) $values, Criteria::IN);
			// invalidate the cache for this object(s)
			foreach ((array) $values as $singleval) {
				CertificadoCupomPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given CertificadoCupom object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      CertificadoCupom $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(CertificadoCupom $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(CertificadoCupomPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(CertificadoCupomPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(CertificadoCupomPeer::DATABASE_NAME, CertificadoCupomPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = CertificadoCupomPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(CertificadoCupomPeer::ID, $pk);

		$v = CertificadoCupomPeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(CertificadoCupomPeer::DATABASE_NAME);
			$criteria->add(CertificadoCupomPeer::ID, $pks, Criteria::IN);
			$objs = CertificadoCupomPeer::doSelect($criteria, $con);
		}
		return $objs;
	}

} // BaseCertificadoCupomPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseCertificadoCupomPeer::buildTableMap();
