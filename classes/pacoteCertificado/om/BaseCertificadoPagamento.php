...
/**
 * Base class that represents a row from the 'certificado_pagamento' table.
 *
 * 
 *
 * @package    pacoteCertificado.om
 */
abstract class BaseCertificadoPagamento extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the data_inclusao field.
	 * @var        string
	 */
	...
	/**
	 * The value for the codigo_pagamento field.
	 * @var        string
	 */
	protected $codigo_pagamento;
	...
	/**
	 * The value for the quantidade_parcelas field.
	 * @var        int
	 */
	protected $quantidade_parcelas;

	/**
	 * The value for the comprovante_pagamento field.
	 * @var        string
	 */
	protected $comprovante_pagamento;
	...
	/**
	 * Get the [optionally formatted] temporal [data_inclusao] column value.
	 * 
	 *
	 * @param      string $format The date/time format string (either date()-style or strftime()-style).
	 *							If format is NULL, then the raw DateTime object will be returned.
	 ...
	 * @throws     PropelException - if unable to parse/validate the date/time value.
	 */
	public function getDataInclusao($format = 'Y-m-d H:i:s')
	{
		...
		if ($this->data_inclusao === '0000-00-00 00:00:00') {
			// while technically this is not a default value of NULL,
			// this seems to be closest in meaning.
			return null;
		} else {
			try {
				$dt = new DateTime($this->data_inclusao);
			} catch (Exception $x) {
				throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->data_inclusao, true), $x);
			}
		}
	...
	/**
	 * Get the [codigo_pagamento] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [quantidade_parcelas] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [comprovante_pagamento] column value.
	 * 
	 * @return     string
	 */
	 ...
	 * @return     CertificadoPagamento The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CertificadoPagamentoPeer::ID;
		}
	...
	public function setDataPagamento($v)
	{
		...
		if ( $this->data_pagamento !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = CertificadoPagamentoPeer::DATA_PAGAMENTO;
			}
	...
	public function setDataConfirmacaoPagamento($v)
	{
		...
		if ( $this->data_confirmacao_pagamento !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = CertificadoPagamentoPeer::DATA_CONFIRMACAO_PAGAMENTO;
			}
		} // if either are not null
	...
	public function setCertificadoId($v)
	{
		...
		if ($this->certificado_id !== $v) {
			...
			$this->modifiedColumns[] = CertificadoPagamentoPeer::CERTIFICADO_ID;
		}
	...
	public function setPedidoId($v)
	{
		...
		if ($this->pedido_id !== $v) {
			$this->pedido_id = $v;
			$this->modifiedColumns[] = CertificadoPagamentoPeer::PEDIDO_ID;
		}
	...
	/**
	 * Sets the value of [data_inclusao] column to a normalized version of the date/time value specified.
	 * 
	 * @param      mixed $v string, integer (timestamp), or DateTime value.  Empty string will
	 *						be treated as NULL for temporal objects.
	 * @return     CertificadoPagamento The current object (for fluent API support)
	...
	public function setDataInclusao($v)
	{
		...
		if ( $this->data_inclusao !== null || $dt !== null ) {
			// (nested ifs are a little easier to read in this case)

			$currNorm = ($this->data_inclusao !== null && $tmpDt = new DateTime($this->data_inclusao)) ? $tmpDt->format('Y-m-d H:i:s') : null;
			$newNorm = ($dt !== null) ? $dt->format('Y-m-d H:i:s') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->data_inclusao = ($dt ? $dt->format('Y-m-d H:i:s') : null);
				$this->modifiedColumns[] = CertificadoPagamentoPeer::DATA_INCLUSAO;
			}
		} // if either are not null
	...
	public function setValor($v)
	{
		...
		if ($this->valor !== $v) {
			$this->valor = $v;
			$this->modifiedColumns[] = CertificadoPagamentoPeer::VALOR;
		}
	...
	/**
	 * Set the value of [codigo_pagamento] column.
	 * 
	 * @param      string $v new value
	 * @return     CertificadoPagamento The current object (for fluent API support)
	 */
	public function setCodigoPagamento($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->codigo_pagamento !== $v) {
			$this->codigo_pagamento = $v;
			$this->modifiedColumns[] = CertificadoPagamentoPeer::CODIGO_PAGAMENTO;
		}
	...
	public function setFormaPagamentoId($v)
	{
		...
		if ($this->forma_pagamento_id !== $v) {
			...
			$this->modifiedColumns[] = CertificadoPagamentoPeer::FORMA_PAGAMENTO_ID;
		}
	...
	/**
	 * Set the value of [quantidade_parcelas] column.
	 * 
	 * @param      int $v new value
	 * @return     CertificadoPagamento The current object (for fluent API support)
	 */
	public function setQuantidadeParcelas($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->quantidade_parcelas !== $v) {
			$this->quantidade_parcelas = $v;
			$this->modifiedColumns[] = CertificadoPagamentoPeer::QUANTIDADE_PARCELAS;
		}
	...
	/**
	 * Set the value of [comprovante_pagamento] column.
	 * 
	 * @param      string $v new value
	 * @return     CertificadoPagamento The current object (for fluent API support)
	 */
	public function setComprovantePagamento($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->comprovante_pagamento !== $v) {
			$this->comprovante_pagamento = $v;
			$this->modifiedColumns[] = CertificadoPagamentoPeer::COMPROVANTE_PAGAMENTO;
		}
	...
	public function setObservacao($v)
	{
		...
		if ($this->observacao !== $v) {
			$this->observacao = $v;
			$this->modifiedColumns[] = CertificadoPagamentoPeer::OBSERVACAO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->data_pagamento = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->data_confirmacao_pagamento = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->certificado_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->pedido_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->data_inclusao = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->valor = ($row[$startcol + 6] !== null) ? (double) $row[$startcol + 6] : null;
			$this->codigo_pagamento = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->forma_pagamento_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->quantidade_parcelas = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->comprovante_pagamento = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			...
			return $startcol + 12; // 12 = CertificadoPagamentoPeer::NUM_COLUMNS - CertificadoPagamentoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating CertificadoPagamento object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CertificadoPagamentoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				CertificadoPagamentoPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				CertificadoPagamentoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CertificadoPagamentoPeer::doInsert($this, $con);
					...
					$affectedRows += CertificadoPagamentoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CertificadoPagamentoPeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CertificadoPagamentoPeer::ID)) $criteria->add(CertificadoPagamentoPeer::ID, $this->id);
		if ($this->isColumnModified(CertificadoPagamentoPeer::DATA_PAGAMENTO)) $criteria->add(CertificadoPagamentoPeer::DATA_PAGAMENTO, $this->data_pagamento);
		if ($this->isColumnModified(CertificadoPagamentoPeer::DATA_CONFIRMACAO_PAGAMENTO)) $criteria->add(CertificadoPagamentoPeer::DATA_CONFIRMACAO_PAGAMENTO, $this->data_confirmacao_pagamento);
		if ($this->isColumnModified(CertificadoPagamentoPeer::CERTIFICADO_ID)) $criteria->add(CertificadoPagamentoPeer::CERTIFICADO_ID, $this->certificado_id);
		if ($this->isColumnModified(CertificadoPagamentoPeer::PEDIDO_ID)) $criteria->add(CertificadoPagamentoPeer::PEDIDO_ID, $this->pedido_id);
		if ($this->isColumnModified(CertificadoPagamentoPeer::DATA_INCLUSAO)) $criteria->add(CertificadoPagamentoPeer::DATA_INCLUSAO, $this->data_inclusao);
		if ($this->isColumnModified(CertificadoPagamentoPeer::VALOR)) $criteria->add(CertificadoPagamentoPeer::VALOR, $this->valor);
		if ($this->isColumnModified(CertificadoPagamentoPeer::CODIGO_PAGAMENTO)) $criteria->add(CertificadoPagamentoPeer::CODIGO_PAGAMENTO, $this->codigo_pagamento);
		if ($this->isColumnModified(CertificadoPagamentoPeer::FORMA_PAGAMENTO_ID)) $criteria->add(CertificadoPagamentoPeer::FORMA_PAGAMENTO_ID, $this->forma_pagamento_id);
		if ($this->isColumnModified(CertificadoPagamentoPeer::QUANTIDADE_PARCELAS)) $criteria->add(CertificadoPagamentoPeer::QUANTIDADE_PARCELAS, $this->quantidade_parcelas);
		if ($this->isColumnModified(CertificadoPagamentoPeer::COMPROVANTE_PAGAMENTO)) $criteria->add(CertificadoPagamentoPeer::COMPROVANTE_PAGAMENTO, $this->comprovante_pagamento);
		if ($this->isColumnModified(CertificadoPagamentoPeer::OBSERVACAO)) $criteria->add(CertificadoPagamentoPeer::OBSERVACAO, $this->observacao);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CertificadoPagamentoPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CertificadoPagamento (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDataInclusao($this->data_inclusao);

		$copyObj->setValor($this->valor);

		$copyObj->setCodigoPagamento($this->codigo_pagamento);

		$copyObj->setFormaPagamentoId($this->forma_pagamento_id);

		$copyObj->setQuantidadeParcelas($this->quantidade_parcelas);

		$copyObj->setComprovantePagamento($this->comprovante_pagamento);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CertificadoPagamento Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CertificadoPagamentoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CertificadoPagamentoPeer();
		}
		return self::$peer;
	}
	...
	public function setCertificado(Certificado $v = null)
	{
		...
		if ($v !== null) {
			$v->addCertificadoPagamento($this);
		}
	...
	public function getCertificado(PropelPDO $con = null)
	{
		if ($this->aCertificado === null && ($this->certificado_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCertificado->addCertificadoPagamentos($this);
			 */
		}
	...
	public function getPedido(PropelPDO $con = null)
	{
		if ($this->aPedido === null && ($this->pedido_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPedido->addCertificadoPagamentos($this);
			 */
		}
		return $this->aPedido;
	}
	...
	public function getFormaPagamento(PropelPDO $con = null)
	{
		if ($this->aFormaPagamento === null && ($this->forma_pagamento_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aFormaPagamento->addCertificadoPagamentos($this);
			 */
		}
