...
/**
 * Base class that represents a row from the 'tipo_aviso' table.
 *
 * 
 *
 * @package    pacoteInformacao.om
 */
abstract class BaseTipoAviso extends BaseObject  implements Persistent {
	 ...
	 * @return     TipoAviso The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TipoAvisoPeer::ID;
		}
	...
	public function setNome($v)
	{
		...
		if ($this->nome !== $v) {
			$this->nome = $v;
			$this->modifiedColumns[] = TipoAvisoPeer::NOME;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = TipoAvisoPeer::DESCRICAO;
		}
	...
	public function setSituacao($v)
	{
		...
		if ($this->situacao !== $v) {
			$this->situacao = $v;
			$this->modifiedColumns[] = TipoAvisoPeer::SITUACAO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = TipoAvisoPeer::NUM_COLUMNS - TipoAvisoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating TipoAviso object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TipoAvisoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				TipoAvisoPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				TipoAvisoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TipoAvisoPeer::doInsert($this, $con);
					...
					$affectedRows += TipoAvisoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TipoAvisoPeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TipoAvisoPeer::ID)) $criteria->add(TipoAvisoPeer::ID, $this->id);
		if ($this->isColumnModified(TipoAvisoPeer::NOME)) $criteria->add(TipoAvisoPeer::NOME, $this->nome);
		if ($this->isColumnModified(TipoAvisoPeer::DESCRICAO)) $criteria->add(TipoAvisoPeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(TipoAvisoPeer::SITUACAO)) $criteria->add(TipoAvisoPeer::SITUACAO, $this->situacao);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TipoAvisoPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of TipoAviso (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     TipoAviso Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TipoAvisoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TipoAvisoPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this TipoAviso has previously been saved, it will retrieve
	 * related Avisos from storage. If this TipoAviso is new, it will return
		...
		if ($this->collAvisos === null) {
			if ($this->isNew()) {
			   $this->collAvisos = array();
				...
				$criteria->add(AvisoPeer::TIPO_AVISO_ID, $this->id);
	 ...
	 * Otherwise if this TipoAviso is new, it will return
	 * an empty collection; or if this TipoAviso has previously
	 * been saved, it will retrieve related Avisos from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in TipoAviso.
	 */
	public function getAvisosJoinUsuario($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TipoAvisoPeer::DATABASE_NAME);
		}
		...
		if ($this->collAvisos === null) {
			if ($this->isNew()) {
				...
				$this->collAvisos = AvisoPeer::doSelectJoinUsuario($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
