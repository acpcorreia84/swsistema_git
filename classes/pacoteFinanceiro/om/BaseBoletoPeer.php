...
/**
 * Base static class for performing query and update operations on the 'boleto' table.
 *
 * 
 *
 * @package    pacoteFinanceiro.om
 */
abstract class BaseBoletoPeer {
	...
	const OM_CLASS = 'Boleto';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'pacoteFinanceiro.Boleto';
	...
	const TID = 'boleto.TID';

	/** the column name for the CERTIFICADO_ID field */
	const CERTIFICADO_ID = 'boleto.CERTIFICADO_ID';

	/** the column name for the PEDIDO_ID field */
	const PEDIDO_ID = 'boleto.PEDIDO_ID';

	/** the column name for the CONTAS_RECEBER_ID field */
	const CONTAS_RECEBER_ID = 'boleto.CONTAS_RECEBER_ID';
	...
	const DATA_PROCESSAMENTO = 'boleto.DATA_PROCESSAMENTO';

	/** the column name for the DATA_PAGAMENTO field */
	const DATA_PAGAMENTO = 'boleto.DATA_PAGAMENTO';

	/** the column name for the DATA_CONFIRMACAO_PAGAMENTO field */
	const DATA_CONFIRMACAO_PAGAMENTO = 'boleto.DATA_CONFIRMACAO_PAGAMENTO';

	/** the column name for the VALOR field */
	const VALOR = 'boleto.VALOR';

	/** the column name for the URL_BOLETO field */
	const URL_BOLETO = 'boleto.URL_BOLETO';

	/** the column name for the DESCRICAO field */
	const DESCRICAO = 'boleto.DESCRICAO';

	/**
	 * An identiy map to hold any loaded instances of Boleto objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. BoletoPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(BoletoPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	{
		$criteria->addSelectColumn(BoletoPeer::ID);
		$criteria->addSelectColumn(BoletoPeer::TID);
		$criteria->addSelectColumn(BoletoPeer::CERTIFICADO_ID);
		...
		$criteria->addSelectColumn(BoletoPeer::DATA_CONFIRMACAO_PAGAMENTO);
		$criteria->addSelectColumn(BoletoPeer::VALOR);
		$criteria->addSelectColumn(BoletoPeer::URL_BOLETO);
		$criteria->addSelectColumn(BoletoPeer::DESCRICAO);
	}
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = BoletoPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return BoletoPeer::populateObjects(BoletoPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      Boleto $value A Boleto object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Boleto $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A Boleto object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Boleto) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Boleto object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     Boleto Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to boleto
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = BoletoPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = BoletoPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				BoletoPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	...
	/**
	 * Selects a collection of Boleto objects pre-filled with their Certificado objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Boleto objects pre-filled with their Pedido objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Boleto objects.
	...
	public static function doSelectJoinPedido(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Boleto) to $obj2 (Pedido)
				$obj2->addBoleto($obj1);
	...
	/**
	 * Selects a collection of Boleto objects pre-filled with their ContasReceber objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Boleto objects.
	...
	public static function doSelectJoinContasReceber(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Boleto) to $obj2 (ContasReceber)
				$obj2->addBoleto($obj1);
	...
	/**
	 * Selects a collection of Boleto objects pre-filled with their Cliente objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Boleto objects.
	...
	public static function doSelectJoinCliente(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Boleto) to $obj2 (Cliente)
				$obj2->addBoleto($obj1);
	...
	/**
	 * Selects a collection of Boleto objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Boleto objects pre-filled with all related objects except Certificado.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseBoletoPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseBoletoPeer::TABLE_NAME))
	  {
	...
	{
		return $withPrefix ? BoletoPeer::CLASS_DEFAULT : BoletoPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Boleto or Criteria object.
	 *
	 * @param      mixed $values Criteria or Boleto object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Boleto object
		}

		if ($criteria->containsKey(BoletoPeer::ID) && $criteria->keyContainsValue(BoletoPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.BoletoPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Boleto or Criteria object.
	 *
	 * @param      mixed $values Criteria or Boleto object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(BoletoPeer::ID);
			$selectCriteria->add(BoletoPeer::ID, $criteria->remove(BoletoPeer::ID), $comparison);

		} else { // $values is Boleto object
	...
	/**
	 * Method to DELETE all rows from the boleto table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(BoletoPeer::TABLE_NAME, $con);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			BoletoPeer::clearInstancePool();
			BoletoPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Boleto or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Boleto) { // it's a model object
			// invalidate the cache for this single object
			BoletoPeer::removeInstanceFromPool($values);
			// create criteria based on pk values
			$criteria = $values->buildPkeyCriteria();
		} else { // it's a primary key, or an array of pks
			$criteria = new Criteria(self::DATABASE_NAME);
			$criteria->add(BoletoPeer::ID, (array) $values, Criteria::IN);
			// invalidate the cache for this object(s)
			foreach ((array) $values as $singleval) {
				BoletoPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given Boleto object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Boleto $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(Boleto $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(BoletoPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(BoletoPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(BoletoPeer::DATABASE_NAME, BoletoPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = BoletoPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(BoletoPeer::ID, $pk);

		$v = BoletoPeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(BoletoPeer::DATABASE_NAME);
			$criteria->add(BoletoPeer::ID, $pks, Criteria::IN);
			$objs = BoletoPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
