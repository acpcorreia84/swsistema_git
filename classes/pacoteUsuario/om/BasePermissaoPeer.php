...
abstract class BasePermissaoPeer {
	...
	const CLASS_DEFAULT = 'pacoteUsuario.Permissao';
	...
	const FUNCAO = 'permissao.FUNCAO';

	/** the column name for the DESCRICAO field */
	const DESCRICAO = 'permissao.DESCRICAO';

	/** the column name for the GRUPO_PERMISSAO_ID field */
	const GRUPO_PERMISSAO_ID = 'permissao.GRUPO_PERMISSAO_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Tela', 'Funcao', 'Descricao', 'GrupoPermissaoId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'tela', 'funcao', 'descricao', 'grupoPermissaoId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TELA, self::FUNCAO, self::DESCRICAO, self::GRUPO_PERMISSAO_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'tela', 'funcao', 'descricao', 'grupo_permissao_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Tela' => 1, 'Funcao' => 2, 'Descricao' => 3, 'GrupoPermissaoId' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'tela' => 1, 'funcao' => 2, 'descricao' => 3, 'grupoPermissaoId' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TELA => 1, self::FUNCAO => 2, self::DESCRICAO => 3, self::GRUPO_PERMISSAO_ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'tela' => 1, 'funcao' => 2, 'descricao' => 3, 'grupo_permissao_id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PermissaoPeer::TELA);
		$criteria->addSelectColumn(PermissaoPeer::FUNCAO);
		$criteria->addSelectColumn(PermissaoPeer::DESCRICAO);
		$criteria->addSelectColumn(PermissaoPeer::GRUPO_PERMISSAO_ID);
	}
	 ...
	 */
	public static function addInstanceToPool(Permissao $obj, $key = null)
	{
	...
	/**
	 * Returns the number of rows matching criteria, joining the related GrupoPermissao table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinGrupoPermissao(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(PermissaoPeer::GRUPO_PERMISSAO_ID, GrupoPermissaoPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Permissao objects pre-filled with their GrupoPermissao objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinGrupoPermissao(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		PermissaoPeer::addSelectColumns($criteria);
		$startcol = (PermissaoPeer::NUM_COLUMNS - PermissaoPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = GrupoPermissaoPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = GrupoPermissaoPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					GrupoPermissaoPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
				
				// Add the $obj1 (Permissao) to $obj2 (GrupoPermissao)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		PermissaoPeer::addSelectColumns($criteria);
		$startcol2 = (PermissaoPeer::NUM_COLUMNS - PermissaoPeer::NUM_LAZY_LOAD_COLUMNS);

		GrupoPermissaoPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (GrupoPermissaoPeer::NUM_COLUMNS - GrupoPermissaoPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined GrupoPermissao rows

			$key2 = GrupoPermissaoPeer::getPrimaryKeyHashFromRow($row, $startcol2);
			if ($key2 !== null) {
				$obj2 = GrupoPermissaoPeer::getInstanceFromPool($key2);
				if (!$obj2) {
				...
				// Add the $obj1 (Permissao) to the collection in $obj2 (GrupoPermissao)
				$obj2->addPermissao($obj1);
	...
	/**
	 * Method perform an INSERT on the database, given a Permissao or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Permissao or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(PermissaoPeer::ID, $criteria->remove(PermissaoPeer::ID), $comparison);
	...
	/**
	 * Method to DELETE all rows from the permissao table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(PermissaoPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Permissao or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(Permissao $obj, $cols = null)
	{
		$columns = array();
