...
/**
 * Base class that represents a row from the 'local_usuario' table.
 *
 * 
 *
 * @package    pacoteUsuario.om
 */
abstract class BaseLocalUsuario extends BaseObject  implements Persistent {
	 ...
	 * @return     LocalUsuario The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = LocalUsuarioPeer::ID;
		}
	...
	public function setLocalId($v)
	{
		...
		if ($this->local_id !== $v) {
			$this->local_id = $v;
			$this->modifiedColumns[] = LocalUsuarioPeer::LOCAL_ID;
		}
	...
	public function setUsuarioId($v)
	{
		...
		if ($this->usuario_id !== $v) {
			$this->usuario_id = $v;
			$this->modifiedColumns[] = LocalUsuarioPeer::USUARIO_ID;
		}
	...
	public function setSituacao($v)
	{
		...
		if ($this->situacao !== $v) {
			$this->situacao = $v;
			$this->modifiedColumns[] = LocalUsuarioPeer::SITUACAO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = LocalUsuarioPeer::NUM_COLUMNS - LocalUsuarioPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating LocalUsuario object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = LocalUsuarioPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				LocalUsuarioPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				LocalUsuarioPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = LocalUsuarioPeer::doInsert($this, $con);
					...
					$affectedRows += LocalUsuarioPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = LocalUsuarioPeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LocalUsuarioPeer::ID)) $criteria->add(LocalUsuarioPeer::ID, $this->id);
		if ($this->isColumnModified(LocalUsuarioPeer::LOCAL_ID)) $criteria->add(LocalUsuarioPeer::LOCAL_ID, $this->local_id);
		if ($this->isColumnModified(LocalUsuarioPeer::USUARIO_ID)) $criteria->add(LocalUsuarioPeer::USUARIO_ID, $this->usuario_id);
		if ($this->isColumnModified(LocalUsuarioPeer::SITUACAO)) $criteria->add(LocalUsuarioPeer::SITUACAO, $this->situacao);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(LocalUsuarioPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of LocalUsuario (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     LocalUsuario Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     LocalUsuarioPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new LocalUsuarioPeer();
		}
		return self::$peer;
	}
	...
	public function getLocal(PropelPDO $con = null)
	{
		if ($this->aLocal === null && ($this->local_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aLocal->addLocalUsuarios($this);
			 */
		}
		return $this->aLocal;
	}
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && ($this->usuario_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuario->addLocalUsuarios($this);
			 */
		}
