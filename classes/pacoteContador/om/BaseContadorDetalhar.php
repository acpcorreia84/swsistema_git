...
/**
 * Base class that represents a row from the 'contador_detalhar' table.
 *
 * 
 *
 * @package    pacoteContador.om
 */
abstract class BaseContadorDetalhar extends BaseObject  implements Persistent {
	 ...
	 * @return     ContadorDetalhar The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ContadorDetalharPeer::ID;
		}
	...
	public function setContadorId($v)
	{
		...
		if ($this->contador_id !== $v) {
			$this->contador_id = $v;
			$this->modifiedColumns[] = ContadorDetalharPeer::CONTADOR_ID;
		}
	...
	public function setUsuarioId($v)
	{
		...
		if ($this->usuario_id !== $v) {
			$this->usuario_id = $v;
			$this->modifiedColumns[] = ContadorDetalharPeer::USUARIO_ID;
		}
	...
	public function setDataCadastro($v)
	{
		...
		if ( $this->data_cadastro !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ContadorDetalharPeer::DATA_CADASTRO;
			}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = ContadorDetalharPeer::DESCRICAO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->contador_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->usuario_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->data_cadastro = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			return $startcol + 5; // 5 = ContadorDetalharPeer::NUM_COLUMNS - ContadorDetalharPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ContadorDetalhar object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(ContadorDetalharPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = ContadorDetalharPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(ContadorDetalharPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		...
		try {
			...
			if ($ret) {
				ContadorDetalharPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ContadorDetalharPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ContadorDetalharPeer::doInsert($this, $con);
					...
					$affectedRows += ContadorDetalharPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ContadorDetalharPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$criteria = new Criteria(ContadorDetalharPeer::DATABASE_NAME);

		if ($this->isColumnModified(ContadorDetalharPeer::ID)) $criteria->add(ContadorDetalharPeer::ID, $this->id);
		if ($this->isColumnModified(ContadorDetalharPeer::CONTADOR_ID)) $criteria->add(ContadorDetalharPeer::CONTADOR_ID, $this->contador_id);
		if ($this->isColumnModified(ContadorDetalharPeer::USUARIO_ID)) $criteria->add(ContadorDetalharPeer::USUARIO_ID, $this->usuario_id);
		if ($this->isColumnModified(ContadorDetalharPeer::DATA_CADASTRO)) $criteria->add(ContadorDetalharPeer::DATA_CADASTRO, $this->data_cadastro);
		if ($this->isColumnModified(ContadorDetalharPeer::DESCRICAO)) $criteria->add(ContadorDetalharPeer::DESCRICAO, $this->descricao);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ContadorDetalharPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ContadorDetalhar (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ContadorDetalhar Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ContadorDetalharPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ContadorDetalharPeer();
		}
		return self::$peer;
	}
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && ($this->usuario_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUsuario->addContadorDetalhars($this);
			 */
		}
	...
	public function getContador(PropelPDO $con = null)
	{
		if ($this->aContador === null && ($this->contador_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aContador->addContadorDetalhars($this);
			 */
		}
