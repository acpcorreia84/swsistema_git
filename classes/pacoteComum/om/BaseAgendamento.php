...
/**
 * Base class that represents a row from the 'agendamento' table.
 *
 * 
 *
 * @package    pacoteComum.om
 */
abstract class BaseAgendamento extends BaseObject  implements Persistent {
	 ...
	 * @return     Agendamento The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AgendamentoPeer::ID;
		}
	...
	public function setCertificadoId($v)
	{
		...
		if ($this->certificado_id !== $v) {
			...
			$this->modifiedColumns[] = AgendamentoPeer::CERTIFICADO_ID;
		}
	...
	public function setDataAgendamento($v)
	{
		...
		if ( $this->data_agendamento !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = AgendamentoPeer::DATA_AGENDAMENTO;
			}
	...
	public function setLocalId($v)
	{
		...
		if ($this->local_id !== $v) {
			$this->local_id = $v;
			$this->modifiedColumns[] = AgendamentoPeer::LOCAL_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->data_agendamento = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->local_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = AgendamentoPeer::NUM_COLUMNS - AgendamentoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Agendamento object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AgendamentoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				AgendamentoPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AgendamentoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AgendamentoPeer::doInsert($this, $con);
					...
					$affectedRows += AgendamentoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AgendamentoPeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AgendamentoPeer::ID)) $criteria->add(AgendamentoPeer::ID, $this->id);
		if ($this->isColumnModified(AgendamentoPeer::CERTIFICADO_ID)) $criteria->add(AgendamentoPeer::CERTIFICADO_ID, $this->certificado_id);
		if ($this->isColumnModified(AgendamentoPeer::DATA_AGENDAMENTO)) $criteria->add(AgendamentoPeer::DATA_AGENDAMENTO, $this->data_agendamento);
		if ($this->isColumnModified(AgendamentoPeer::LOCAL_ID)) $criteria->add(AgendamentoPeer::LOCAL_ID, $this->local_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AgendamentoPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Agendamento (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Agendamento Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AgendamentoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AgendamentoPeer();
		}
		return self::$peer;
	}
	...
	public function getLocal(PropelPDO $con = null)
	{
		if ($this->aLocal === null && ($this->local_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aLocal->addAgendamentos($this);
			 */
		}
		return $this->aLocal;
	}
	...
	public function getCertificado(PropelPDO $con = null)
	{
		if ($this->aCertificado === null && ($this->certificado_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCertificado->addAgendamentos($this);
			 */
		}
