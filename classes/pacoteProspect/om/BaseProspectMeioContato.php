...
/**
 * Base class that represents a row from the 'prospect_meio_contato' table.
 *
 * 
 *
 * @package    pacoteProspect.om
 */
abstract class BaseProspectMeioContato extends BaseObject  implements Persistent {
	 ...
	 * @return     ProspectMeioContato The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ProspectMeioContatoPeer::ID;
		}
	...
	public function setNome($v)
	{
		...
		if ($this->nome !== $v) {
			$this->nome = $v;
			$this->modifiedColumns[] = ProspectMeioContatoPeer::NOME;
		}
	...
	public function setSituacao($v)
	{
		...
		if ($this->situacao !== $v) {
			$this->situacao = $v;
			$this->modifiedColumns[] = ProspectMeioContatoPeer::SITUACAO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ProspectMeioContatoPeer::NUM_COLUMNS - ProspectMeioContatoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ProspectMeioContato object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProspectMeioContatoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ProspectMeioContatoPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ProspectMeioContatoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ProspectMeioContatoPeer::doInsert($this, $con);
					...
					$affectedRows += ProspectMeioContatoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ProspectMeioContatoPeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProspectMeioContatoPeer::ID)) $criteria->add(ProspectMeioContatoPeer::ID, $this->id);
		if ($this->isColumnModified(ProspectMeioContatoPeer::NOME)) $criteria->add(ProspectMeioContatoPeer::NOME, $this->nome);
		if ($this->isColumnModified(ProspectMeioContatoPeer::SITUACAO)) $criteria->add(ProspectMeioContatoPeer::SITUACAO, $this->situacao);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ProspectMeioContatoPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ProspectMeioContato (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ProspectMeioContato Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ProspectMeioContatoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ProspectMeioContatoPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this ProspectMeioContato has previously been saved, it will retrieve
	 * related ProspectSituacaos from storage. If this ProspectMeioContato is new, it will return
		...
		if ($this->collProspectSituacaos === null) {
			if ($this->isNew()) {
			   $this->collProspectSituacaos = array();
				...
				$criteria->add(ProspectSituacaoPeer::PROSPECT_MEIO_CONTATO_ID, $this->id);
	 ...
	 * Otherwise if this ProspectMeioContato is new, it will return
	 * an empty collection; or if this ProspectMeioContato has previously
	 * been saved, it will retrieve related ProspectSituacaos from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in ProspectMeioContato.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this ProspectMeioContato has previously been saved, it will retrieve
	 * related ProspectAtendimentos from storage. If this ProspectMeioContato is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collProspectAtendimentos === null) {
			if ($this->isNew()) {
			   $this->collProspectAtendimentos = array();
				...
				$criteria->add(ProspectAtendimentoPeer::PROSPECT_MEIO_CONTATO_ID, $this->id);
