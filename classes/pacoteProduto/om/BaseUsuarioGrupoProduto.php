...
/**
 * Base class that represents a row from the 'usuario_grupo_produto' table.
 *
 * 
 *
 * @package    pacoteProduto.om
 */
abstract class BaseUsuarioGrupoProduto extends BaseObject  implements Persistent {
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = UsuarioGrupoProdutoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				UsuarioGrupoProdutoPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				UsuarioGrupoProdutoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = UsuarioGrupoProdutoPeer::doInsert($this, $con);
					...
					$affectedRows += UsuarioGrupoProdutoPeer::doUpdate($this, $con);
				}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UsuarioGrupoProduto (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     UsuarioGrupoProduto Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     UsuarioGrupoProdutoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new UsuarioGrupoProdutoPeer();
		}
		return self::$peer;
	}
