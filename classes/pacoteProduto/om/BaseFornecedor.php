 ...
 */
abstract class BaseFornecedor extends BaseObject  implements Persistent {
	 ...
	 * @return     Fornecedor The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = FornecedorPeer::ID;
		}
	...
	public function setNome($v)
	{
		...
		if ($this->nome !== $v) {
			$this->nome = $v;
			$this->modifiedColumns[] = FornecedorPeer::NOME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = FornecedorPeer::NUM_COLUMNS - FornecedorPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Fornecedor object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(FornecedorPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = FornecedorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(FornecedorPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		...
		try {
			...
			if ($ret) {
				FornecedorPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				FornecedorPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = FornecedorPeer::doInsert($this, $con);
					...
					$affectedRows += FornecedorPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FornecedorPeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FornecedorPeer::ID)) $criteria->add(FornecedorPeer::ID, $this->id);
		if ($this->isColumnModified(FornecedorPeer::NOME)) $criteria->add(FornecedorPeer::NOME, $this->nome);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(FornecedorPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Fornecedor (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Fornecedor Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     FornecedorPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new FornecedorPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this Fornecedor has previously been saved, it will retrieve
	 * related Produtos from storage. If this Fornecedor is new, it will return
