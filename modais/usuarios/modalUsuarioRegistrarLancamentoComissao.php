<div id="modalUsuarioRegistrarLancamentoComissao" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <div class ="col-lg-10">
                    <h3><i class="fa fa-2x fa-floppy-o"></i> Registrar Lan&ccedil;amento na planilha de Comiss&atilde;o do Usu&aacute;rio </h3>
                </div>
                <div class ="col-lg-2">
                    ...
                    <a class="btn btn-danger" data-toggle="modal" data-target="#modalUsuarioRegistrarLancamentoComissao"><i class="fa fa-lg fa-close"></i></a>
                </div>
            </div>
