<div id="modalContadorRegistrarComissao" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <div class ="col-lg-10">
                    <h3><i class="fa fa-2x fa-floppy-o"></i> Registrar Comiss&atilde;o do Contador</h3>
                </div>
                <div class ="col-lg-2">
                    ...
                    <a class="btn btn-danger" data-toggle="modal" data-target="#modalContadorRegistrarComissao"><i class="fa fa-lg fa-close"></i></a>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <div id="divBtnRegistrarComissaoContador">
                    <button class="btn btn-info" id="btnRegistrarComissao" onclick="registrarComissaoContador()"><i class="fa fa-floppy-o" aria-hidden="true"></i> Registrar </button>
                </div>
            </div>
        </div>
